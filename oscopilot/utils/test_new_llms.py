...
def main():
    ...
    # request_params = {'model': 'gpt-4-0125-preview', 'messages': messages, 'stream': True, 'api_key': 'YOUR_API_KEY_HERE', 'api_base': 'https://api.chatweb.plus/v1', 'functions': [functions]}
    response = ''
